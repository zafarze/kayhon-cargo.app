						...
						<AnimatePresence>
							{isNotifOpen && (
								<motion.div
									...
									className="fixed left-4 right-4 top-[85px] origin-top sm:absolute sm:left-auto sm:right-0 sm:top-14 sm:w-80 bg-white rounded-3xl shadow-2xl border border-slate-100 overflow-hidden z-50 sm:origin-top-right"
								>
